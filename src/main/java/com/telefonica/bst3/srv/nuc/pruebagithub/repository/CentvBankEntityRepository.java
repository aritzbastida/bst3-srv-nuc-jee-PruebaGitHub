 ...
 * 
 */
@Repository(value = "com.telefonica.bst3.srv.nuc.pruebagithub.repository.CentvBankEntityRepository")
public interface CentvBankEntityRepository extends JpaRepository<CentvBankEntity, BigDecimal>,
        JpaSpecificationExecutor<CentvBankEntity>, CentvBankEntityRepositoryExtension {
